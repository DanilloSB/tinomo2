			...
			<div class="wrap-login100">
				...
				<form action="{{ route('registrar_cliente') }}" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate ="Endereço  Correto">
						<input class="input100" type="text" name="end_cliente" required placeholder="Endereco Completo">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
						    <i aria-hidden="true"></i>
						</span>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Telefone Válido">
                        <input class="input100" type="text" name="telefone_cliente" required placeholder="Telefone: (xx) xxxxx-xxxx">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i aria-hidden="true"></i>
						</span>
